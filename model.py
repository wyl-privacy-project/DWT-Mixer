...
from DWTMixer import DWT_MIXER
...
class DWTMixerSeqCls(nn.Module):
    def __init__(
        self,
        ...
        **kwargs
        ...
        super(DWTMixerSeqCls, self).__init__(**kwargs)
        self.mixer_cfg = mixer_cfg
        self.ts_mixer = DWTMixer(bottleneck_cfg, mixer_cfg, model_name)
